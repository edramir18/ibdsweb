...
--------------------------------------------------------
  ...
  ALTER TABLE "IBDS"."LOGS" ADD CONSTRAINT "LOGS_FK_CANAL" FOREIGN KEY ("ID")
	  REFERENCES "IBDS"."CANAL" ("ID") ENABLE;
  ALTER TABLE "IBDS"."LOGS" ADD CONSTRAINT "LOGS_FK_TRANSACCION" FOREIGN KEY ("ID")
	  REFERENCES "IBDS"."TRANSACCION" ("ID") ENABLE;
  ALTER TABLE "IBDS"."LOGS" ADD CONSTRAINT "LOGS_FK_USUARIO" FOREIGN KEY ("ID")
